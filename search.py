...
def uniformCostSearch(problem):
    ...
    while not frontier.isEmpty():
        ...
        if node not in expanded:
            ...
            for child, action, cost in problem.getSuccessors(node):
                if child not in expanded:
                    frontier.push((child, path_to_node + [action]), problem.getCostOfActions(path_to_node) + cost)
    return []
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not frontier.isEmpty():
        ...
        if node not in expanded:
            ...
            for child, action, cost in problem.getSuccessors(node):
                if child not in expanded:
                    frontier.push((child, path_to_node + [action]), problem.getCostOfActions(path_to_node) + cost + heuristic(child, problem))
    return []
